...
>
> Last updated: <!--auto-date-->2026-08-07<!--/auto-date-->
...
| 22 | `positions_deep.js` | 公開 62 本書（不含中貴）每一個局面（`--full-public` 全掃，不再 \|d12\|>500 截斷）；滾動補完中 | <!--auto-d22-->145,371<!--/auto-d22--> |
| 28 | `positions_very_deep.js` | (a) 已偵測 trap 的前後兩格再深算驗證；(b) 精讀書（順包 7 本 + 牛頭滾 2 本 + 半途列包 7 本）ply≥15 全掃、套 \|d12\|>500 截斷 — ✅ 2026-07-12 完工 | <!--auto-d28-->102,145<!--/auto-d28--> |
...
**第三批 🔄 2026-08-06 加入（排週五 8/7 22:00 blitz）：** 中砲巡河車對屏風馬搶三卒 + 中砲三兵五八砲對屏風馬
（主人今日擴充 2 本、+~10.6k d12 FENs），d28 todo **~11,274**（~477/hr 估 ~24h、週六晚前完）。
...
| 中砲巡河車對屏風馬搶三卒 + 中砲三兵五八砲對屏風馬（頂層 2 本）| — | ~11,274 | 🔄 排 8/7 blitz |
...
一次性 blitz** `ChessBookD28BookWeekend`（見上表；第二批✅完工、第三批排 8/7），夜間單實例維持停用。
...
| `ChessBookVerifyDepth28` | `verify_traps.py` | 21:00 daily | 對 <!--auto-traps-->2660<!--/auto-traps--> traps × 2 跑 d28 |
