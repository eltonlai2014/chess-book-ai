...
>
> Last updated: <!--auto-date-->2026-07-11<!--/auto-date-->
...
| 28 | `positions_very_deep.js` | (a) 已偵測 trap 的前後兩格再深算驗證；(b) 順包/ 5 本 + 牛頭滾 2 本 ply≥15 全掃，同樣套 \|d12\|>500 截斷 | <!--auto-d28-->58,388<!--/auto-d28--> |
...
| `ChessBookVerifyDepth28` | `verify_traps.py` | 21:00 daily | 對 <!--auto-traps-->2310<!--/auto-traps--> traps × 2 跑 d28 |
