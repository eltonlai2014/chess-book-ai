...
| 28 | `positions_very_deep.js` | (a) 已偵測 trap 的前後兩格再深算驗證；(b) 精讀書（順包 7 本 + 牛頭滾 2 本 + 半途列包 7 本）ply≥15 全掃、套 \|d12\|>500 截斷 — ✅ 2026-07-12 完工 | <!--auto-d28-->102,249<!--/auto-d28--> |
...
| `ChessBookVerifyDepth28` | `verify_traps.py` | 21:00 daily | 對 <!--auto-traps-->2661<!--/auto-traps--> traps × 2 跑 d28 |
