...
>
> Last updated: <!--auto-date-->2026-09-23<!--/auto-date-->
...
| 22 | `positions_deep.js` | 公開 62 本書（不含中貴）每一個局面（`--full-public` 全掃，不再 \|d12\|>500 截斷）；滾動補完中 | <!--auto-d22-->164,888<!--/auto-d22--> |
| 28 | `positions_very_deep.js` | (a) 已偵測 trap 的前後兩格再深算驗證；(b) 精讀書（順包 7 本 + 牛頭滾 2 本 + 半途列包 7 本）ply≥15 全掃、套 \|d12\|>500 截斷 — ✅ 2026-07-12 完工 | <!--auto-d28-->113,582<!--/auto-d28--> |
...
| `ChessBookVerifyDepth28` | `verify_traps.py` | 21:00 daily | 對 <!--auto-traps-->3077<!--/auto-traps--> traps × 2 跑 d28 |
