...
>
> Last updated: <!--auto-date-->2026-06-28<!--/auto-date-->
...
| 28 | `positions_very_deep.js` | (a) 已偵測 trap 的前後兩格再深算驗證；(b) 順包/ 5 本 + 牛頭滾 2 本 ply≥15 全掃，同樣套 \|d12\|>500 截斷 | <!--auto-d28-->10,704<!--/auto-d28--> |
| 32 | `positions_d32.js` | 順包/ 中 d28 已跑過的 FEN，再加深到 32 做交叉驗證（看 d28 結論穩不穩） | <!--auto-d32-->4,452<!--/auto-d32--> |
...
| `ChessBookVerifyDepth28` | `verify_traps.py` | 21:00 daily | 對 <!--auto-traps-->1944<!--/auto-traps--> traps × 2 跑 d28 |
